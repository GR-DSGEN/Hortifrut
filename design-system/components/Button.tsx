  ...
  return (
    ...
    <button style={_mergeOverrides({ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "var(--ds-spacing-4, 16px)", paddingRight: "var(--ds-spacing-4, 16px)", paddingTop: "0px", paddingBottom: "0px", width: "fit-content", height: "var(--ds-sizes-components-md, 36px)", flexShrink: 0, position: "relative", boxSizing: "border-box", background: "var(--ds-primary-default, #18181b)", color: "var(--ds-primary-foreground, #fafafa)", borderRadius: "var(--ds-radius-md, 6px)" }, [{ selector: {"Variant":"default","State":"hover"}, patch: { opacity: 0.9 } }, { selector: {"Variant":"default","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"default","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Variant":"secondary"}, patch: { background: "var(--ds-secondary-default, #18181b)", color: "var(--ds-secondary-foreground, #fafafa)", opacity: 1 } }, { selector: {"Variant":"secondary","State":"hover"}, patch: { opacity: 0.8 } }, { selector: {"Variant":"secondary","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"secondary","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Variant":"destructive"}, patch: { background: "var(--ds-destructive-default, #18181b)", color: "var(--ds-destructive-foreground, #fafafa)", opacity: 1 } }, { selector: {"Variant":"destructive","State":"hover"}, patch: { opacity: 0.9 } }, { selector: {"Variant":"destructive","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"destructive","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Variant":"outline"}, patch: { background: "var(--ds-base-background, #18181b)", color: "var(--ds-base-foreground, #fafafa)", border: `1px solid ${"var(--ds-input, #e4e4e7)"}`, opacity: 1 } }, { selector: {"Variant":"outline","State":"hover"}, patch: { background: "var(--ds-accent-default, #f4f4f5)", color: "var(--ds-accent-foreground, #18181b)" } }, { selector: {"Variant":"outline","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"outline","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Variant":"ghost"}, patch: { background: "#00000000", color: "var(--ds-base-foreground, #fafafa)", opacity: 1 } }, { selector: {"Variant":"ghost","State":"hover"}, patch: { background: "var(--ds-accent-default, #f4f4f5)", color: "var(--ds-accent-foreground, #18181b)" } }, { selector: {"Variant":"ghost","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"ghost","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Variant":"link"}, patch: { background: "#00000000", color: "var(--ds-primary-default, #fafafa)", opacity: 1 } }, { selector: {"Variant":"link","State":"disabled"}, patch: { opacity: 0.5 } }, { selector: {"Variant":"link","State":"focus"}, patch: { border: `2px solid ${"var(--ds-ring, #a1a1aa)"}` } }, { selector: {"Size":"xs"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-1, 8px)", paddingLeft: "var(--ds-spacing-2, 16px)", paddingRight: "var(--ds-spacing-2, 16px)", paddingTop: "0px", paddingBottom: "0px", width: "fit-content", height: "var(--ds-sizes-scale-7, 28px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"sm"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "var(--ds-spacing-3, 16px)", paddingRight: "var(--ds-spacing-3, 16px)", paddingTop: "0px", paddingBottom: "0px", width: "fit-content", height: "var(--ds-sizes-components-sm, 32px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"lg"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "var(--ds-spacing-8, 16px)", paddingRight: "var(--ds-spacing-8, 16px)", paddingTop: "0px", paddingBottom: "0px", width: "fit-content", height: "var(--ds-sizes-components-lg, 40px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"icon-xs"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "0px", width: "var(--ds-sizes-scale-7, 28px)", height: "var(--ds-sizes-scale-7, 28px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"icon-sm"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "0px", width: "var(--ds-sizes-components-sm, 32px)", height: "var(--ds-sizes-components-sm, 32px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"icon"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "0px", width: "var(--ds-sizes-components-md, 36px)", height: "var(--ds-sizes-components-md, 36px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Size":"icon-lg"}, patch: { borderRadius: "var(--ds-radius-md, 6px)", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "0px", width: "var(--ds-sizes-components-lg, 40px)", height: "var(--ds-sizes-components-lg, 40px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }, { selector: {"Variant":"link"}, patch: { background: "#00000000", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: "var(--ds-spacing-2, 8px)", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", paddingBottom: "0px", width: "fit-content", height: "var(--ds-sizes-components-md, 36px)", flexShrink: 0, position: "relative", boxSizing: "border-box" } }], _ctx) as React.CSSProperties} type={props.type ?? "button"} disabled={props.disabled || undefined} onMouseEnter={() => setState("hover" as any)} onMouseLeave={() => setState("default" as any)} onClick={(e) => props.onClick?.(e)}>
      ...
      <span style={{ ...(({ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", position: "relative", boxSizing: "border-box" }) as React.CSSProperties), animation: "ds-spin 1s linear infinite" }}>
        <span style={{ display: "inline-flex", width: "var(--ds-icon-md, 16px)", height: "var(--ds-icon-md, 16px)", color: "currentColor", flexShrink: 0 } as React.CSSProperties} dangerouslySetInnerHTML={{ __html: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>` }} />
      </span>
      )}
      {((_ctx.HasIcon === true)) && (
      <span style={{ display: "inline-flex", width: "var(--ds-icon-md, 16px)", height: "var(--ds-icon-md, 16px)", color: "currentColor", flexShrink: 0 } as React.CSSProperties} dangerouslySetInnerHTML={{ __html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"/></svg>` }} />
      )}
      {((_ctx.IconOnly === false)) && (
      <span style={_mergeOverrides({ color: "var(--ds-primary-foreground, #fafafa)", fontFamily: `var(--ds-typography-families-sans)`, fontSize: `var(--ds-typography-scale-fontSize-200)`, fontWeight: `var(--ds-typography-weights-medium)`, lineHeight: `var(--ds-typography-scale-lineHeight-200)`, letterSpacing: `var(--ds-typography-scale-letterSpacing-200)`, textAlign: "center" }, [{ selector: {"Variant":"secondary"}, patch: { color: "var(--ds-secondary-foreground, #fafafa)" } }, { selector: {"Variant":"destructive"}, patch: { color: "var(--ds-destructive-foreground, #fafafa)" } }, { selector: {"Variant":"outline"}, patch: { color: "var(--ds-base-foreground, #fafafa)" } }, { selector: {"Variant":"outline","State":"hover"}, patch: { color: "var(--ds-accent-foreground, #18181b)" } }, { selector: {"Variant":"ghost"}, patch: { color: "var(--ds-base-foreground, #fafafa)" } }, { selector: {"Variant":"ghost","State":"hover"}, patch: { color: "var(--ds-accent-foreground, #18181b)" } }, { selector: {"Variant":"link"}, patch: { color: "var(--ds-primary-default, #fafafa)" } }, { selector: {"Variant":"link","State":"hover"}, patch: { textDecoration: "underline" } }, { selector: {"Size":"xs"}, patch: { fontFamily: `var(--ds-typography-roles-body-steps-xs-fontFamily, ui-sans-serif)`, fontSize: `var(--ds-typography-roles-body-steps-xs-fontSize, 14px)`, fontWeight: `var(--ds-typography-roles-body-steps-xs-fontWeight, 400)`, lineHeight: `var(--ds-typography-roles-body-steps-xs-lineHeight, 1.4)` } }, { selector: {"Size":"icon-xs"}, patch: { display: "none" } }, { selector: {"Size":"icon-sm"}, patch: { display: "none" } }, { selector: {"Size":"icon"}, patch: { display: "none" } }, { selector: {"Size":"icon-lg"}, patch: { display: "none" } }], _ctx) as React.CSSProperties}>{String((props.Label) ?? "Button")}</span>
      )}
      {props.children}
    </button>
    </React.Fragment>
